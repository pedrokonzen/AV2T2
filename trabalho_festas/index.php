                        ...
                        <div class="btns">
                            <div class="desc">
                                <form action="index.php" method="post">
                                    <input type="hidden" value="descNome" name="filter">
                                    <span class="material-symbols-outlined" for="filter">
                                        expand_less
                                    </span>
                                </form>
                            </div>
...
?>
        ...
        <div class="btn">
            <a href='festasRealizadas.php'>Festas Passadas</a>
        </div>
        <div class="btn">
            <a href='proximasFestas.php'>Festas Posteriores</a>
        </div>
        <div class="btn">
            <a href='cidadesFestas.php'>Festas por Cidade</a>
        </div>
        <div class="btn">
            <a href='festasMes.php'>Festas por Mes</a>
        </div>
        <div class="btn">
            <a href='festasAno.php'>Festas por Ano</a>
        </div>
        <div class="btn">
            <a href='diasRestantes.php'>Dias restantes</a>
        </div>
    </div>
